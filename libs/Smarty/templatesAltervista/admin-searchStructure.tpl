                  ...
                  {foreach from=$objects['skiFacilities'] item=element}
                    <div class="card">
                      ...
                      <div class="action-buttons">
                        ...
                        <form class="search-form" action="/Admin/deleteSkiFacility" method="POST">
                ...
                {foreach from=$objects['skiRun'] item=element}
                  <div class="card">
                    ...
                    <div class="action-buttons">
                      ...
                      <form class="search-form" action="/Admin/deleteSkiRun" method="POST">
                ...
                {foreach from=$objects['liftStructure'] item=element}  
                  <div class="card">
                    ...
                    <div class="action-buttons">
                      ...
                      <form class="search-form" action="/Admin/deleteLiftStructure" method="POST">
