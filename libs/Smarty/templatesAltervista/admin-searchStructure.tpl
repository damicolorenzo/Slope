      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="form-container">
          <div class="admin-filter-container">
            ...
            <div class="filters">
              <form class="search-form" action="/Admin/searchStructures" method="POST">
                ...
                {foreach from=$objects['skiFacilities'] item=element}
                  <div class="card">
                    <div class="user-info">
                      ...
                      <p>Stato: {$element->getStatus()}</p>
                      <p>Descrizione: {$element->getDescription()}</p>
                    </div>
                    <div class="action-buttons">
                      <form class="search-form" action="/Admin/modifySkiFacility" method="POST">
                        <button type="submit" name="idSkiFacility" value={$element->getIdSkiFacility()} class="edit">Modifica</button>
                      </form>
                      <form class="search-form" action="/Admin/deleteSkiFacility" mathod="POST">
                ...
                {foreach from=$objects['skiRun'] item=element}
                  <div class="card">
                    <div class="user-info">
                      ...
                      <p>Stato: {$element[0]->getStatus()}</p>
                      <p>Impianto di riferimento: {$element[1]['name']}</p>
                    </div>
                    <div class="action-buttons">
                      <form class="search-form" action="/Admin/modifySkiRun" method="POST">
                        <button type="submit" name="idSkiRun" value={$element[0]->getIdSkiRun()} class="edit">Modifica</button>
                      </form>
                      <form class="search-form" action="/Admin/deleteSkiRun" mathod="POST">
              ...
              <div class="structure-cards-container">
                {foreach from=$objects['liftStructure'] item=element}  
                  <div class="card">
                    ...
                    <div class="action-buttons">
                      <form class="search-form" action="/Admin/modifyLiftStructure" method="POST">
                        <button type="submit" name="idLift" value={$element[0]->getIdLift()} class="edit">Modifica</button>
                      </form>
                      <form class="search-form" action="/Admin/deleteLiftStructure" mathod="POST">
