      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="form-container searchStructures">
          <div class="admin-filter-container">
            ...
            <div class="filters">
              <form class="search-form" action="/SearchAdmin/searchStructures" method="POST">
            ...
            <div class="structures">
                  ...
                  {foreach from=$objects['skiFacilities'] item=element}
                    <div class="card">
                      ...
                      <div class="action-buttons">
                        <form class="search-form" action="/ModifyAdmin/modifySkiFacility" method="POST">
                          <button type="submit" name="idSkiFacility" value={$element->getIdSkiFacility()} class="edit">Modifica</button>
                        </form>
                        <form class="search-form" action="/DeleteAdmin/deleteSkiFacility" method="POST">
              ...
              <div class="structure-cards-container">
                {foreach from=$objects['skiRun'] item=element}
                  <div class="card">
                    <div class="user-info">
                      <p>Nome: {$element[0]->getName()}</p>
                      <p>Tipologia: {$element[0]->getType()}</p>
                      {if $element[0]->getStatus()}
                      <p>Stato: Aperto</p>
                      {else}
                      <p>Stato: Chiuso</p>
                      {/if}
                    ...
                    <div class="action-buttons">
                      <form class="search-form" action="/ModifyAdmin/modifySkiRun" method="POST">
                        <button type="submit" name="idSkiRun" value={$element[0]->getIdSkiRun()} class="edit">Modifica</button>
                      </form>
                      <form class="search-form" action="/DeleteAdmin/deleteSkiRun" method="POST">
                ...
                {foreach from=$objects['liftStructure'] item=element}  
                  <div class="card">
                    <div class="user-info">
                      ...
                      <p>Stato: Chiuso</p>
                      {/if}
                      <p>Sedute: {$element[0]->getSeats()}</p>
                      <p>Impianto di riferimento: {$element[1]}</p>
                    </div>
                    <div class="action-buttons">
                      <form class="search-form" action="/ModifyAdmin/modifyLiftStructure" method="POST">
                        <button type="submit" name="idLift" value={$element[0]->getIdLift()} class="edit">Modifica</button>
                      </form>
                      <form class="search-form" action="/DeleteAdmin/deleteLiftStructure" method="POST">
