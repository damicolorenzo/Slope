        ...
        <div class="layout">
          ...
          <div class="sidebar-wrapper">
            <nav class="dashboard" id="sidebar">
              <a href="/AddAdmin/addSkiRun">Aggiungi dati pista</a>
              <a href="/AddAdmin/addSkiFacility">Aggiungi dati impianto</a>
              <a href="/AddAdmin/addLiftStructure">Aggiungi dati risalita</a>
              <a href="/AddAdmin/addSkipassTemplate">Aggiungi template skipass</a>
              <a href="/AddAdmin/addInsuranceTemplate">Aggiungi template assicurazione</a>
              <a href="/AddAdmin/addSubscription">Aggiungi template abbonamento</a>
              <a href="/AddAdmin/addSkipassObj">Aggiungi oggetto skipass</a>
              <a href="/SearchAdmin/searchStructures">Modifica dati pista/impianto/risalita</a>
              <a href="/SearchAdmin/searchSkipassTemplate">Modifica template skipass</a>
              <a href="/SearchAdmin/searchInsuranceTemplate">Modifica template assicurazione</a>
              <a href="/SearchAdmin/searchSubscriptionTemplate">Modifica template abbonamento</a>
              <a href="/SearchAdmin/searchSkipassObjs">Modifica oggetto skipass</a>
              <a href="/ModifyAdmin/modifySkiFacilityImage">Modifica immagini impianto</a>
              <a href="/SearchAdmin/searchUsers">Modifica dati utente</a>
              <a href="/SearchAdmin/searchSkipassBooking">Modifica prenotazione skipass utente</a>
              <a href="/ModifyAdmin/modifyLandingPage">Modifica interfaccia</a>
            </nav>
          </div>
