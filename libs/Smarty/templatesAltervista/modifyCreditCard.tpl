...
<head>
  ...
  <title>Modifica carta di credito</title>
    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container modifyCreditCard" data-aos="fade-up">
        ...
        <div class="form-container">
            <form action="/Slope/UserOperations/confirmModifyCreditCard" enctype="multipart/form-data" method="POST">
              <h2>Modifica dati carta di credito</h2>
              <label for="cardHolderName">Nome Intestatario Carta</label>
              <input type="text" id="card-name" name="cardHolderName" value={$cardHName} required>
              <label for="cardHolderSurname">Cognome Intestatario Carta</label>
              <input type="text" id="card-surname" name="cardHolderSurname" value={$cardHSurname} required>
              <label for="cardNumber">Numero Carta</label>
              <input type="text" id="card-number" name="cardNumber" placeholder="**** **** **** {$cardNumber}" maxlength="16"  required>
              <label for="expiryDate">Scadenza Carta</label>
              <input type="month" id="expiry-date" name="expiryDate" value="{$expiryDate}" required>
