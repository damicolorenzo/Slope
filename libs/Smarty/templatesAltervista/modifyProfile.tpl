      ...
      <div class="container modifyProfile" data-aos="fade-up">
        ...
        <div class="form-container">
            <div class="profile-info">
                <form action="/User/confirmModify" enctype="multipart/form-data" method="POST">
            ...
            <div class="button-container">
              <a href="/User/modifyPassword"><button class="edit-button">Modifica password</button></a>
            </div>
            <p><strong>Modifica immagine:</strong></p>
            <div class="button-container">
              <a href="/User/modifyProfileImage"><button class="edit-button">Modifica immagine</button></a>
            </div>
