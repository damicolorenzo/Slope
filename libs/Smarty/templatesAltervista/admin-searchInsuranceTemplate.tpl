    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="form-container searchInsuranceTemplate">
        <div class="admin-filter-container">
          ...
          <div class="filters">
            <form class="search-form" action="/SearchAdmin/searchInsuranceTemplate" method="POST">
        ...
        {if count($insuranceTemps) > 0}
          <div class="structures">
            <div class="structure-cards-container">
            {foreach from=$insuranceTemps item=i}
              <div class="card">
                ...
                <div class="action-buttons">
                  <form action="/ModifyAdmin/modifyInsuranceTemp" method="POST">
                    <button type="submit" name="idInsuranceTemp" value={$i->getIdInsuranceTemp()} class="edit">Modifica</button>
                  </form>
                  <form action="/DeleteAdmin/deleteInsuranceTemp" method="POST">
