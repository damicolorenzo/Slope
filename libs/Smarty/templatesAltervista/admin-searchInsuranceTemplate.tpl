    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="form-container searchInsuranceTemplate">
        <div class="admin-filter-container">
          ...
          <div class="filters">
            <form class="search-form" action="/Admin/searchInsuranceTemplate" method="POST">
            ...
            {foreach from=$insuranceTemps item=i}
              <div class="card">
                ...
                <div class="action-buttons">
                  <form action="/Admin/modifyInsuranceTemp" method="POST">
                    <button type="submit" name="idInsuranceTemp" value={$i->getIdInsuranceTemp()} class="edit">Modifica</button>
                  </form>
                  <form action="/Admin/deleteInsuranceTemp" method="POST">
