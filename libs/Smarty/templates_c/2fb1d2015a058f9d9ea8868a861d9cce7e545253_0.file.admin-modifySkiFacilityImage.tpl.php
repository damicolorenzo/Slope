...
function content_68235718980305_60974823 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
>
            ...
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['map']->value[$_smarty_tpl->tpl_vars['i']->value->getIdSkiFacility()], 'f');
if ($_from !== null) {
...
" alt="Immagine di <?php echo $_smarty_tpl->tpl_vars['i']->value->getName();?>
">
              <?php
}
}
