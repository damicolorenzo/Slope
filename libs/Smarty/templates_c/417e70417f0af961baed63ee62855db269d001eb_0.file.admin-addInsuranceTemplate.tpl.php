...
function content_685da15112c682_87866780 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Aggiungi template assicurazione</title>
    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="form-container addInsuranceTemplate">
          ...
          <form class="register-form" action="/Slope/ConfirmModifyAdmin/confirmInsuranceTemp" method="POST">
