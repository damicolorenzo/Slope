...
>
              ...
              <label for="startDate">Data inizio abbonamento: <?php echo $_smarty_tpl->tpl_vars['startDate']->value;?>
</label>
              <input type="hidden" id="startDate" name="startDate" value=<?php echo $_smarty_tpl->tpl_vars['startDate']->value;?>
>
              
              <label for="startDate">Data fine abbonamento: <?php echo $_smarty_tpl->tpl_vars['endDate']->value;?>
</label>
              <input type="hidden" id="endDate" name="endDate" value=<?php echo $_smarty_tpl->tpl_vars['endDate']->value;?>
>
