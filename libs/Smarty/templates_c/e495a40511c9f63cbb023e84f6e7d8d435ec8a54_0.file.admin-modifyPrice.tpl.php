<?php
/* Smarty version 3.1.33, created on 2025-01-03 12:08:49
  from 'C:\xampp\htdocs\Slope\libs\Smarty\templates\admin-modifyPrice.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6777c541927bb5_67338755',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e495a40511c9f63cbb023e84f6e7d8d435ec8a54' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Slope\\libs\\Smarty\\templates\\admin-modifyPrice.tpl',
      1 => 1735902526,
      2 => 'file',
    ),
  ),
...
function content_6777c541927bb5_67338755 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  ...
  <main class="main">
    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container" data-aos="fade-up">
        <div>
        <form action="/Slope/Admin/confirmModifyPrice" enctype="multipart/form-data" method="POST">
            <h2>MODIFICA Prezzo</h2>
            <input type="hidden" id="idPrice" name="idPrice" value=<?php echo $_smarty_tpl->tpl_vars['idPrice']->value;?>
>
...
>
            ...
            <input type="text" id="description" name="description" value="<?php echo $_smarty_tpl->tpl_vars['description']->value;?>
" required>

            <p><strong>Full:</strong></p>
            <input type="text" id="full" name="full" value="<?php echo $_smarty_tpl->tpl_vars['full']->value;?>
" required>

            <p><strong>Reduced:</strong></p>
            <input type="text" id="reduced" name="reduced" value="<?php echo $_smarty_tpl->tpl_vars['reduced']->value;?>
" required>

            <p><strong>Impianto di riferimento:</strong></p>                          
            <select name="skiFacility">
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['skiFacilityNames']->value, 'i');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['i']->value) {
?>
                <?php if ($_smarty_tpl->tpl_vars['i']->value == $_smarty_tpl->tpl_vars['nameSkiFacility']->value) {?>
