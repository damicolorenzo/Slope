<?php
/* Smarty version 3.1.33, created on 2025-06-24 11:55:08
  from 'C:\xampp\htdocs\Slope\libs\Smarty\templates\admin-addSkipassObj.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_685a75fc0fdde3_10537685',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '174c5a757cdd2821504fc6f5375065fa0d3af5cc' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Slope\\libs\\Smarty\\templates\\admin-addSkipassObj.tpl',
      1 => 1750755421,
      2 => 'file',
    ),
  ),
...
function content_685a75fc0fdde3_10537685 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Aggiungi oggetto skipass</title>
    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="form-container addSkipassObj">
          <form action="/Slope/ConfirmModifyAdmin/confirmSkipassObj" enctype="multipart/form-data" method="POST">
              <h2>Aggiungi oggetto skipass</h2>
            
              <label for="description">Descrizione oggetto skipass:</label>
              <input type="text" name="description" placeholder="Inserisci descrizione dello skipass">
...
?>
                  <label><input type="radio" name="idSkiFacility" value=<?php echo $_smarty_tpl->tpl_vars['i']->value->getIdSkiFacility();?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <div class="radio-group">
              <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['templates']->value, 'i');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['i']->value) {
?>
                  <label><input type="radio" name="idSkipassTemplate" value=<?php echo $_smarty_tpl->tpl_vars['i']->value->getIdSkipassTemplate();?>
><?php echo $_smarty_tpl->tpl_vars['i']->value->getDescription();?>
-<?php echo $_smarty_tpl->tpl_vars['i']->value->getType();?>
</label>
              <?php
}
}
