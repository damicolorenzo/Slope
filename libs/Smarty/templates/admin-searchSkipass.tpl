  ...
  <main class="main">
    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container" data-aos="fade-up">
        ...
        {if count($skipassObjs) > 0}
          <div class="skipassObjs">
            <div class="cards-container">
            {foreach from=$skipassObjs item=i}
              <div class="card">
                ...
                <div>
                  <form action="/Slope/Admin/modifySkipass" method="POST">
                    <button type="submit" name="idSkipassObj" value={$i->getIdSkipassObj()} class="edit">Modifica</button>
                  </form>
                  <form action="/Slope/Admin/deleteSkipass" method="POST">
                    <button type="submit" name="idSkipassObj" value={$i->getIdSkipassObj()} class="delete">Elimina</button>
                  </form>
                </div>
              </div>
            {/foreach}
