...
<head>
  ...
  <title>Modifica template skipass</title>
    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container" data-aos="fade-up">
        <div class="form-container modifySkipassTemp">
          <form action="/Slope/ConfirmModifyAdmin/confirmModifySubscriptionTemp" enctype="multipart/form-data" method="POST">
            <h2>Modifica template assicurazione</h2>
            <input type="hidden" id="idSubscriptionTemp" name="idSubscriptionTemp" value={$idSubscriptionTemp}>
