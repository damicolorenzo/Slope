    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form action="/Slope/Admin/confirmModifyPrice" enctype="multipart/form-data" method="POST">
            ...
            <input type="hidden" id="idPrice" name="idPrice" value={$idPrice}>
            ...
            <input type="text" id="full" name="full" value="{$full}" required>

            <p><strong>Reduced:</strong></p>
            <input type="text" id="reduced" name="reduced" value="{$reduced}" required>

            <p><strong>Impianto di riferimento:</strong></p>                          
            <select name="skiFacility">
            {foreach from=$skiFacilityNames item=i}
                {if $i == $nameSkiFacility}
