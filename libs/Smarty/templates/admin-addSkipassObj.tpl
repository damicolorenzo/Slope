        ...
        <div class="form-container addSkipassObj">
          <form action="/Slope/ConfirmModifyAdmin/confirmSkipassObj" enctype="multipart/form-data" method="POST">
              ...
              {foreach from=$skiFacilities item=i}
                  <label><input type="radio" name="idSkiFacility" value={$i->getIdSkiFacility()}>{$i->getName()}</label>
              {/foreach}
              </div>
              ...
              {foreach from=$templates item=i}
                  <label><input type="radio" name="idSkipassTemplate" value={$i->getIdSkipassTemplate()}>{$i->getDescription()}-{$i->getType()}</label>
              {/foreach}
              </div>
