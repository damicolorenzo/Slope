    ...
    <section id="starter-section" class="starter-section section"> 
      ...
      <div class="container" data-aos="fade-up">
        <div class="form-container">
          <form action="/Slope/Admin/confirmModifySkipassObj" enctype="multipart/form-data" method="POST">
            ...
            <label><input type="radio" name="idSkiFacility" value={$skiFacility->getIdSkiFacility()} checked>{$skiFacility->getName()}</label>
            </div>

            <label>Descrizione template</label>
            <div class="radio-group">
            <label><input type="radio" name="idSkipassTemplate" value={$skipassTemp->getIdSkipassTemplate()} checked>{$skipassTemp->getDescription()}</label>
            </div>
