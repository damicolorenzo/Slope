...
class EPrice {
    ...
    public function getIdExternalObj() : int {return $this->idExternalObj;}
    ...
    public function getExtObjClass() : string {return $this->extObjClass;}
    ...
    public function setIdExternalObj(string $idExternalObj) : void {$this->idExternalObj = $idExternalObj;}
    public function setExtObjClass(string $extObjClass) : void {$this->extObjClass = $extObjClass;}
